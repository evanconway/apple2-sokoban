...
0010 GR
0020 HOME
0030 DIM LA(8, 8) : REM DECLARE LEVEL ARRAY
...
1010 FOR LY = 1 TO 8 : REM LEVEL X
1020 FOR LX = 1 TO 8 : REM LEVEL Y
1030 READ CELL
1040 LA(LY, LX) = CELL
1060 NEXT LX
1070 NEXT LY
...
2010 FOR WY = 1 TO 8 : REM WORLD X
2020 FOR WX = 1 TO 8 : REM WORLD Y
...
3020 FOR WY = 0 TO 9
3030 FOR WX = 0 TO 9
3040 IF WX = 0 OR WX = 9 OR WY = 0 OR WY = 9 THEN GOTO 4000
